	...
	\begin{enumerate}
		...
		\item Shape Particle Filter
			\begin{enumerate}
				...
				Zuletzt wurde noch der Einfluss der Kostenfunktion mit quadrierter Summer der Abweichungen untersucht. Dabei stieg der Fehler erneut und es kamen deutlich größere Ausreißer dazu, da bei manchen Bildern, z.Bsp. Bild 48, die Klassifikation sehr schlecht war (Abbildung~%todo bild).
